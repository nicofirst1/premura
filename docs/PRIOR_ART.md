# premura — Prior-Art Research Brief (Executable)

> Self-contained brief for a deep-research agent with `WebSearch` + `WebFetch` access.
> Output → `docs/PRIOR_ART_RESULTS.md` in the same repo.
>
...
- Do not write code. Do not change any file other than `docs/PRIOR_ART_RESULTS.md`.
...
Write `docs/PRIOR_ART_RESULTS.md` with at least:
...
`docs/PRIOR_ART_RESULTS.md` should look like:
