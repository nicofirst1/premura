...
- **T024**: live-doc sync — STATUS/ROADMAP reflect the shipped rail/road; CHANGELOG mission narrative; `mcp/entrypoint.py` module-docstring tool count/prose updated (prefer pointing at the inventory test over restating a number).
