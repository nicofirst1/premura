...
- **Local-first privacy is non-negotiable** at every stage: cleartext never leaves the machine, no telemetry, network only on explicit user action at Stage 3 (`docs/product/VISION.md` Pillar 6; `docs/architecture/STAGES.md` §3).
