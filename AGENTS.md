...
> Top-level pointer for humans and AI agents contributing to Premura. Short by
> design — the deep, code-coupled contracts live next to the code. Follows the
> emerging [agents.md](https://agents.md) convention.
